...
# Database connection
connection = pymysql.connect(host='localhost',user='root', password="@Swaruparam12",database='resume')
...
def run():
    ...
    if choice == 'Normal User':
        ...
        if st.button('Login'):
            if ad_user == 'roshninekkanti' and ad_password == '@Swaruparam12':
                st.success("Welcome Roshni")
                # Display Data
